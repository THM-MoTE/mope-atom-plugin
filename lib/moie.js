...
export default {
  ...
  listRecentProjects() {
    this.client.recentProjects().then((projectPaths) => {
      console.log("got paths ", projectPaths)
      /* TODO
        1. display list of projects
        2. let user choose a project
        3. open project in new window and connect to server
       */
      atom.notifications.addError("Feature not implemented yet!")
    })
  },
