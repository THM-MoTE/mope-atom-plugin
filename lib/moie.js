...
const uri = `https://github.com/THM-MoTE/mope-server/releases/download/v${serverVersion}/mope-server-${serverVersion}.jar`
...
export default {
  ...
  downloadServer() {
    ...
    if(fileObj.exists() && fileObj.isFile()) {
      ...
      atom.notifications.addInfo("Download server", {detail: `Starting download of mope-server-${serverVersion}.jar`})
