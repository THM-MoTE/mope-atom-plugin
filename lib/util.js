...
export default {
  ...
  getConfigPath() {
    return electron.remote.app.getPath("home") + "/.moie/moie.conf"
  },
  getLogPath() {
    return electron.remote.app.getPath("home") + "/.moie/moie-server.log"
  },
  openConfig() {
    ...
    const exit = code => {
      ...
      switch(code) {
        ...
        case this.serverExitCodes.UNMODIFIED_CONFIG:
          ...
          break
        default:
        console.log("WARNING: moie-server exited abnormally with:", code)
      }
    }
  ...
  wordBelowCursor() {
    ...
    return this.wordBelowPosition(cursorPos, buffer)
  },
